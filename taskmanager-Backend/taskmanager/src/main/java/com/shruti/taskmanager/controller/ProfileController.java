...
import com.shruti.taskmanager.services.ProfileService;
import com.shruti.taskmanager.services.UserService;
...
public class ProfileController {
    ...
    public Profile uploadProfile(
        ...
        // 🔹 Fetch the User and link it to the Profile
        ...
        profile.setBio(bio);
        profile.setPhotoUrl(file.getOriginalFilename()); // ✅ This saves just the filename
